                    ...
                    <>
                     ...
                     <div className="flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2">
                        ...
                        className={`text-gray-400 hover:text-blue-500 ${currentUser && comment.likes.includes(currentUser._id)}`} 
                          onClick={() => onLike(comment._id)} type="button">
               ...
               <div className="flex items-center pt-2 text-xs border-t
                  dark:border-gray-700 max-w-fit gap-2">
                    ...
                    </p>
                    {
                        currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                            <>
                             <buton onClick={handleEdit} className="text-gray-400 hover:text-blue-500">
                                   Editer
                             </buton>
                             <buton onClick={() => onDelete(comment._id)} className="text-gray-400 hover:text-blue-500">
                                   Supprimer
                             </buton>
                            </>
                        )
